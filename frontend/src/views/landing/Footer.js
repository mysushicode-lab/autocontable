...
export default function Footer() {
  return (
    ...
    <footer className="bg-white border-t border-gray-200 mt-32">
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-12 md:gap-6">

        {/* Left — brand */}
        <div className="flex flex-col gap-4 md:max-w-[220px] shrink-0">
          <span className="text-[#181818] font-semibold text-sm tracking-wide">Autocontable</span>
          <span className="text-xs text-[#6b7280]">© 2025 Autocontable</span>
          <div className="flex items-center gap-3 mt-1">
            <a href="mailto:contact@autocontable.fr"
              className="px-3 h-8 flex items-center justify-center rounded-md border border-gray-200 hover:border-gray-300 hover:text-[#181818] transition-colors text-xs text-[#6b7280]">
              Contact
            </a>
            <a href="https://www.linkedin.com/company/autocontable" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              className="group w-8 h-8 flex items-center justify-center rounded-md border border-gray-200 hover:border-gray-300 transition-colors">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 fill-[#6b7280] group-hover:fill-[#181818] transition-colors">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/autocontable.fr" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              className="group w-8 h-8 flex items-center justify-center rounded-md border border-gray-200 hover:border-gray-300 transition-colors">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 fill-[#6b7280] group-hover:fill-[#181818] transition-colors">
        ...
        {/* Right — link columns */}
        <div className="flex flex-wrap gap-8 md:gap-10 lg:gap-12 md:ml-auto">

          <div className="flex flex-col gap-3">
            <span className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold">Produit</span>
            <Link href="/#features" className="text-xs text-[#6b7280] hover:text-[#181818] transition-colors">Fonctionnalités</Link>
            <Link href="/#pricing" className="text-xs text-[#6b7280] hover:text-[#181818] transition-colors">Tarifs</Link>
            <Link href="/login" className="text-xs text-[#6b7280] hover:text-[#181818] transition-colors">Se connecter</Link>
          </div>
