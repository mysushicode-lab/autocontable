...
const ResetPassword = () => {
  ...
  const mutation = useMutation(
    ...
    {
      onSuccess: () => {
        navigate('/login', { state: { message: 'Mot de passe réinitialisé avec succès. Connectez-vous avec votre nouveau mot de passe.' } });
      },
      onError: (err) => {
        ...
        <div className="w-full max-w-md">
          <div className="relative">
            ...
            <div className="relative rounded-md border border-white/30 bg-white/70 p-8 shadow-sm backdrop-blur-md text-center">
              ...
              <button onClick={() => navigate('/forgot-password')} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium text-sm">
