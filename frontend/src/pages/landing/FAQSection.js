...
const FAQS = [
  { q: "Suis-je prêt pour la réforme FEC 2026 ?", a: "Non, et ce n'est pas votre faute. La réforme impose FEC normé + Factur-X dès janvier 2026. Autocontable génère automatiquement les deux, audit trail complet, conforme aux normes comptables. Vous êtes prêt en 14 jours." },
  { q: "Je dois vraiment changer de logiciel comptable ?", a: "Non. Autocontable se greffe sur Sage, Cegid, ACD, Quadratus (ou n'importe quel logiciel). API native ou export FEC au format attendu. Zéro rupture. Votre plan comptable, vos workflows, vos habitudes — inchangés." },
