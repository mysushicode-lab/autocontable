...
const TOP_FEATURES = [
  { title: 'Classification Intelligente', description: "Catégorisation automatique adaptée à votre secteur : pièces détachées, peinture, fournitures d'atelier, sous-traitance, équipement, énergie, assurance, frais généraux, et plus encore.", image: '/modification-facture.png' },
    ...
    <section className="relative bg-[#f7f7f5] overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-52 lg:pt-28 lg:pb-72">
        ...
        <div className="text-center mb-10 lg:mb-16">
          ...
          <h2 className={sectionHeading}>Conçu pour les PME françaises. Pas de comptabilité générique.</h2>
          <p className={`mt-3 max-w-md mx-auto ${sectionSubtext}`}>
            Autocontable automatise tout le cycle de vie des factures pour les PME françaises avec des fonctionnalités spécifiques à votre activité.
          </p>
        </div>
