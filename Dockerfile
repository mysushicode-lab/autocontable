...
LABEL version="1.15" maintainer="Picsou83 <picsou83@gmail.com>"
...
RUN apt-get update && apt-get install -q -y \
	...
	libdbd-pg-perl libapache-session-perl libjson-perl libmime-tools-perl \
	libnet-imap-simple-perl libnet-imap-simple-ssl-perl \
	libemail-mime-perl libemail-address-perl libcrypt-ssleay-perl \
	libtimedate-perl liblist-moreutils-perl \
	vim poppler-utils supervisor && \
